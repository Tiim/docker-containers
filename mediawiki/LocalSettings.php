...
$wgServer = getenv("PROTOCOL"). "://". getenv("HOST");
...
$wgEmergencyContact = "example@something.invalid";
$wgPasswordSender = "example@something.invalid";
